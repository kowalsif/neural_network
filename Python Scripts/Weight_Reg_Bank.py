...
def WeightRegBankTB(numUnits):
        ...
        f.write('WeightRegBank UUT(dataIn, address, write, reset, clk')
        for i in range(numUnits):
                f.write(', out{}'.format(i))
        f.write(');\n\n')
        ...
        f.write('clk = 0; ')
        for i in range(numUnits):
                f.write('dataIn = {0}; address = {0}; write = 0; reset = 1; #5;\n'.format(i))
                f.write('dataIn = {0}; address = {0}; write = 1; reset = 0 #5;\n'.format(i))
